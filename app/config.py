...
class Settings(BaseSettings):
    ...
    observation_hydration_enabled: bool = Field(default=True, alias="OBSERVATION_HYDRATION_ENABLED")
    ...
    clean_observation_verification_enabled: bool = Field(default=True, alias="CLEAN_OBSERVATION_VERIFICATION_ENABLED")
    clean_observation_verification_min_runs: int = Field(default=2, ge=1, alias="CLEAN_OBSERVATION_VERIFICATION_MIN_RUNS")
    clean_observation_verification_min_results: int = Field(default=8, ge=1, alias="CLEAN_OBSERVATION_VERIFICATION_MIN_RESULTS")
    clean_observation_require_current_risk_clean: bool = Field(default=True, alias="CLEAN_OBSERVATION_REQUIRE_CURRENT_RISK_CLEAN")
    fresh_observation_validation_enabled: bool = Field(default=True, alias="FRESH_OBSERVATION_VALIDATION_ENABLED")
    fresh_observation_min_completed_runs: int = Field(default=2, ge=1, alias="FRESH_OBSERVATION_MIN_COMPLETED_RUNS")
    fresh_observation_min_results: int = Field(default=8, ge=1, alias="FRESH_OBSERVATION_MIN_RESULTS")
    fresh_observation_require_current_risk_clean: bool = Field(default=True, alias="FRESH_OBSERVATION_REQUIRE_CURRENT_RISK_CLEAN")
    fresh_observation_allow_legacy_warnings: bool = Field(default=True, alias="FRESH_OBSERVATION_ALLOW_LEGACY_WARNINGS")
    ...
    controlled_paper_review_enabled: bool = Field(default=True, alias="CONTROLLED_PAPER_REVIEW_ENABLED")
    controlled_paper_audit_enabled: bool = Field(default=True, alias="CONTROLLED_PAPER_AUDIT_ENABLED")
    controlled_paper_review_history_limit: int = Field(default=100, ge=1, alias="CONTROLLED_PAPER_REVIEW_HISTORY_LIMIT")
    controlled_paper_audit_require_zero_live_trades: bool = Field(default=True, alias="CONTROLLED_PAPER_AUDIT_REQUIRE_ZERO_LIVE_TRADES")
    controlled_paper_audit_require_paper_broker_only: bool = Field(default=True, alias="CONTROLLED_PAPER_AUDIT_REQUIRE_PAPER_BROKER_ONLY")
    controlled_paper_audit_require_real_execution_false: bool = Field(default=True, alias="CONTROLLED_PAPER_AUDIT_REQUIRE_REAL_EXECUTION_FALSE")
    ...
    controlled_paper_preflight_review_enabled: bool = Field(default=True, alias="CONTROLLED_PAPER_PREFLIGHT_REVIEW_ENABLED")
    controlled_paper_decision_require_preflight: bool = Field(default=True, alias="CONTROLLED_PAPER_DECISION_REQUIRE_PREFLIGHT")
    controlled_paper_decision_require_audit_pass: bool = Field(default=True, alias="CONTROLLED_PAPER_DECISION_REQUIRE_AUDIT_PASS")
    controlled_paper_decision_require_fresh_validation: bool = Field(default=True, alias="CONTROLLED_PAPER_DECISION_REQUIRE_FRESH_VALIDATION")
    controlled_paper_decision_require_approval_eligible: bool = Field(default=True, alias="CONTROLLED_PAPER_DECISION_REQUIRE_APPROVAL_ELIGIBLE")
    controlled_paper_decision_require_strong_buy: bool = Field(default=True, alias="CONTROLLED_PAPER_DECISION_REQUIRE_STRONG_BUY")
    controlled_paper_decision_require_risk_approved: bool = Field(default=True, alias="CONTROLLED_PAPER_DECISION_REQUIRE_RISK_APPROVED")
    controlled_paper_decision_require_current_risk_clean: bool = Field(default=True, alias="CONTROLLED_PAPER_DECISION_REQUIRE_CURRENT_RISK_CLEAN")
    controlled_paper_decision_allow_legacy_warnings: bool = Field(default=True, alias="CONTROLLED_PAPER_DECISION_ALLOW_LEGACY_WARNINGS")
    controlled_paper_decision_min_completed_runs: int = Field(default=5, ge=1, alias="CONTROLLED_PAPER_DECISION_MIN_COMPLETED_RUNS")
    controlled_paper_decision_min_observations: int = Field(default=20, ge=1, alias="CONTROLLED_PAPER_DECISION_MIN_OBSERVATIONS")
    controlled_paper_decision_min_strong_buy_count: int = Field(default=1, ge=0, alias="CONTROLLED_PAPER_DECISION_MIN_STRONG_BUY_COUNT")
    ...
    risk_hygiene_legacy_records_block_paper_readiness: bool = Field(default=False, alias="RISK_HYGIENE_LEGACY_RECORDS_BLOCK_PAPER_READINESS")
    risk_hygiene_legacy_records_warn_only: bool = Field(default=True, alias="RISK_HYGIENE_LEGACY_RECORDS_WARN_ONLY")
    risk_hygiene_require_current_cleanliness: bool = Field(default=True, alias="RISK_HYGIENE_REQUIRE_CURRENT_CLEANLINESS")
    risk_hygiene_current_record_lookback: int = Field(default=100, ge=1, alias="RISK_HYGIENE_CURRENT_RECORD_LOOKBACK")

...
class CommandSummaryBuilder:
    ...
    def build(self) -> CommandSummary:
        ...
        commands = [
            ...
            {"label": "Strategy review checkpoint", "command": r'Invoke-RestMethod -Uri "http://127.0.0.1:8000/strategy/review-checkpoint"'},
            {"label": "Extended observation plan", "command": r'Invoke-RestMethod -Uri "http://127.0.0.1:8000/strategy/extended-observation-plan"'},
            ...
            {"label": "V1 freeze report", "command": r'Invoke-RestMethod -Uri "http://127.0.0.1:8000/audit/v1-freeze-report"'},
            {"label": "V1 handoff package", "command": r'Invoke-RestMethod -Uri "http://127.0.0.1:8000/operator/v1-handoff-package"'},
            {"label": "Future roadmap", "command": r'Invoke-RestMethod -Uri "http://127.0.0.1:8000/operator/future-roadmap"'},
            {"label": "Next project plan", "command": r'Invoke-RestMethod -Uri "http://127.0.0.1:8000/operator/next-project-plan"'},

"""Phase 32 safety regression tests."""
...
def test_no_kraken_addorder_added() -> None:
    """Kraken AddOrder remains absent from executable code."""
    text = read_python(["app", "scripts"])
...
def test_no_withdrawal_or_options_execution_added() -> None:

"""Phase 40 safety regression tests."""
...
def test_no_paper_or_live_trading_enabled_by_default() -> None:
    ...
    assert settings.strategy_review_allow_threshold_changes is False
    assert settings.strategy_review_allow_paper_trades is False
    assert settings.strategy_review_allow_live_review is False

"""Phase 39 safety regression tests."""
...
def test_no_paper_or_live_trading_enabled_by_default() -> None:
    ...
    assert settings.observation_continuation_allow_paper_trades is False
    assert settings.observation_continuation_allow_live_review is False
